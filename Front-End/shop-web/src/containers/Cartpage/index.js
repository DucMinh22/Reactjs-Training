...
import { removeAllCartProducts } from '../../action/action'
...
export default function CartPage() {
    ...
    return (
        <div className="cartPage">
            {loading && <Loading />}
            <p style={{ fontWeight: '700' }}>Total products in your cart: {cartProducts.length}</p>
            <hr></hr>
            <div className="title">
                <h3>Your Cart</h3>
                <Button1 disabled={cartProducts?.length === 0} onClick={removeAllProducts}>Remove All</Button1>
            </div>
                ...
                <Row>
                    ...
                    <Col span={12}>
                        <div className="payment__content">
                            ...
                            <Button1 disabled={total === 0} onClick={handlePurchase}>Purchase</Button1>
                        </div>
                    </Col>
                </Row>
            </div>
